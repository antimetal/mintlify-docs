...
Antimetal uses a read-only service principal scoped to the subscriptions you select. No write or data-plane operations are performed in your Azure environment.
