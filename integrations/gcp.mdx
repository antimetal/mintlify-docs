...
This role provides read-only access. It does not permit changing or deleting infrastructure.

Open **IAM & Admin > IAM** in each relevant project. Find the existing service-account email and click **Edit principal**, or select **Grant access** if it is not listed. Add the role below:
