...
<Note>
  Only connect this integration if your team uses Azure DevOps for source control, work items, or pipelines. It is not required for the [Azure](/integrations/azure) cloud integration.
</Note>
